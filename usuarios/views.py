...
from .forms import CustomUserCreationForm, UsuarioForm, UserBasicForm  # importe os forms personalizados
...
def registro(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            messages.success(request, 'Usuário criado com sucesso! Agora faça login.')
